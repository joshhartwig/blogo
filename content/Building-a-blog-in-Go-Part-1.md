...
Why a blog? So boring and simple! When the rubber meets the road, most things are boring and (sometimes) simple. Complex systems are usually many simple systems coaxed together. I learn by creating stuff I would actually use and what we this series creates is the same software that is running this blog (assuming I am didn't move it to Wordpress).
